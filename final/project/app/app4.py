...
import psutil
from flask import Flask, render_template, request, json, redirect, url_for, jsonify, session, make_response, flash
...
def get_system_info():
    ...
    system_info = {
        ...
        '磁盘使用': {partition.device: f"{psutil.disk_usage(partition.mountpoint).percent}%" for partition in disk_stats},
        '磁盘I/O信息': get_disk_io()
    }
